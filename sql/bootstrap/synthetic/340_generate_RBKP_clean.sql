...
-- Layer   : bootstrap
-- Folder  : synthetic
-- File    : 340_generate_RBKP_clean.sql
--
-- Purpose:
--   Generate clean invoice document header (RBKP) data representing
--   valid, well-formed external source system output.
--
-- Description:
--   This script generates a synthetic but semantically valid dataset
--   for invoice document header (RBKP). The generated data represents
...
--
-- Outputs:
--   Clean synthetic RBKP dataset, persisted temporarily within the
