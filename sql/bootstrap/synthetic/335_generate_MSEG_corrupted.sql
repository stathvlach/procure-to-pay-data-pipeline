...
-- Layer   : bootstrap
-- Folder  : synthetic
-- File    : 335_generate_MSEG_corrupted.sql
--
-- Purpose:
--   Generate corrupted material document items (MSEG) data by applying
--   controlled data-quality issues to an otherwise clean baseline.
--
-- Description:
--   This script produces a corrupted variant of the synthetic MSEG dataset
