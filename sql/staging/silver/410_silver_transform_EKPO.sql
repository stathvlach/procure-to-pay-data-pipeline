...
-- Layer   : staging
-- Folder  : silver
-- File    : 410_silver_transform_EKPO.sql
--
-- Purpose :
--   Transform raw bronze purchase order items (EKPO) data into a cleaned,
--   standardized silver representation suitable for operational loading.
--
-- Description:
--   This script refines purchase order items data from the staging bronze
...
--   Typically runs after 310_bronze_load_EKPO.sql has completed.
--
-- Notes :
